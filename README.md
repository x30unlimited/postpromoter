...
**For ease of use, and in case you just want to provide one single public key for all scopes (owner, active, posting & memo) just provide one single public key (in WIF format) in the memo.**
