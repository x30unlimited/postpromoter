...
function timeTilTargetPower(cur_power, target){
     return timeTilFullPower(cur_power) - timeTilFullPower(target);
 }
...
function format(n, c, d, t) {
 ...
 function log(msg) { if (process.env.NODE_ENV !== 'test' || process.env.verbose) console.log(new Date().toString() + ' - ' + msg); }
